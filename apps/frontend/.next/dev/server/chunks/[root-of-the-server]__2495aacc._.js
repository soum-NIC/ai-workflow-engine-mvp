...
"[project]/apps/frontend/app/api/tasks/dependency/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$infra$2f$db$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('tasks').update(updates).eq('id', task_id).select().single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2495aacc._.js.map