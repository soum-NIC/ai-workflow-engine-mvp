...
"[project]/apps/frontend/app/api/ai/chat/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
${tasks.map((t)=>`- [${t.status}] ${t.title} (ID: ${t.id}${t.parent_id ? `, Parent: ${t.parent_id}` : ''}${t.depends_on?.length > 0 ? `, Depends on: ${t.depends_on.join(', ')}` : ''})`).join('\n')}
...
`;
        ...
        if (!response.ok) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Groq Failure: ${response.status}`,
                details: errBody
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0bef1542._.js.map